...
proc `*`*(error: ColorQuantizeError, scalar: int): ColorQuantizeError =
    return ColorQuantizeError(red: error.red * scalar, green: error.green * scalar, blue: error.blue * scalar)

proc `div`*(error: ColorQuantizeError, scalar: int): ColorQuantizeError =
    return ColorQuantizeError(red: error.red div scalar, green: error.green div scalar, blue: error.blue div scalar)

proc `+`*(a, b: ColorQuantizeError): ColorQuantizeError =
    return ColorQuantizeError(red: a.red + b.red, green: a.green + b.green, blue: a.blue + b.blue)
